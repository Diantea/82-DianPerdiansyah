            ...
            <div class="d-flex align-items-end row">
                <div class="col-7">
                    <div class="card-body text-nowrap">
                        <h4 class="card-title mb-0">Halo, </h4>
                        <p class="mb-3">Selamat datang di Aplikasi PKL 🎉</p>
    
                            <a href="" class="btn btn-primary waves-effect waves-light">Buat Laporan Harian</a>
                       
                            <a href="" class="btn btn-primary waves-effect waves-light">Lihat Laporan</a>
                    </div>
                </div>
