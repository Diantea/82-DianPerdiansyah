...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="row">
            <div class="col-12">
                @include('layouts.profile', ['user' => $teacher])
            </div>
                ...
                <div class="card">
                    ...
                    <div class="card-datatable table-responsive pt-0">
                        <table class="datatables-basic table">
                            ...
                            <tbody>
                                @foreach($teacher->students as $i => $student)
                                    <tr>
                    ...
                    <div class="modal fade" id="add-student-modal" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <form action="{{ route('teacher.add_student', $teacher) }}" method="POST">
                                    @csrf
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel1">Tambahkan Siswa</h5>
                                        <button
                                            type="button"
                                            class="btn-close"
                                    ...
                                    <div class="modal-body">
                                        <div class="row">
                                            <div class="col-12 mb-3">
                                                ...
                                                <input type="text" class="form-control" value="{{ $teacher->major->name }}" disabled>
                                            </div>
                                            <div class="col-12 mb-3">
                                                ...
                                                <select name="student_id" id="student_id" class="selectpicker form-control" data-style="btn-default" data-live-search="true">
                                                    @php
                                                    $students = collect($teacher->major->students)->filter(function($student) use ($teacher) {
                                                        return !in_array($student->id, collect($teacher->students)->pluck('id')->values()->all());
                                                    })
                                                @endphp
