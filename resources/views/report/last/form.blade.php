                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ $item ? route('last-report.update', $item) : route('last-report.store')}}" method="POST" enctype="multipart/form-data">
                            ...
                            @include('forms.file', ['label' => 'Laporan Akhir PKL', 'field' => 'file_1'])

                            @include('forms.file', ['label' => 'Dokumentasi pendukung photo/video', 'field' => 'file_2'])

                            @include('forms.file', ['label' => 'Nilai Evaluasi Akhir Pembimbing Lapangan', 'field' => 'file_3'])
