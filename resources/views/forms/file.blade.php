<div class="form-group mb-3">
    ...
    {{-- untuk menampilkan file berdasarkan tipe file --}}
    @if($item)
        {{-- untuk memeriksa tipe file dan menampilkan tombol unduh jika bukan gambar --}}
        @if(isset($item[$field . '_type']) && !in_array($item[$field . '_type'], ['png', 'jpg', 'jpeg', 'svg', 'gif']))
            ...
            @endif
        @else
        {{-- untuk menampilkan gambar jika file adalah tipe gambar --}}
            @if(isset($field_url))
